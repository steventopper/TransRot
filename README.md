...
<ul>
    ...
    <li>Write Energies When Static Temperature (true/false): When Static Temperature is enabled, enabling this option saves the energy of the system after each attempted move to energies.txt.</li>
